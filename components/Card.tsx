...
const Card = (p:Props) => {
  ...
  return (
  <>
    <div className='card w-96 bg-gray-200 dark:bg-gray-400/25 p-5 m-5 rounded-3xl dark:backdrop-blur-3xl relative top-16 md:scale-90 md:hover:scale-100 duration-700'>
