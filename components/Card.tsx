...
const Card = (p:Props) => {
  ...
  return (
    <div className='card w-96 bg-gray-400/25 p-5 m-5 rounded-3xl backdrop-blur-3xl relative top-32'>
        ...
        <button className='bg-sky-300 text-blue-800 backdrop-blur-3xl m-1 py-1 px-3 rounded-3xl cursor-auto fixed bottom-1'>{p.data.siteSafety}</button>
