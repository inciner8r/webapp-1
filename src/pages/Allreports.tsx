...
import AllReportsContainer from '../Components/Allreportscontainer';
...
const AllReport = () => {
  ...
  const [votestatus, setvotestatus] = useState<string>("running");
  ...
  useEffect(() => {
    ...
    const filteredData = payload.filter(item => item.status === votestatus);
    setprojectsData(filteredData);
          console.log("all reports", payload)
        }
      } catch (error) {
  ...
  }, [buttonset, currentPage, votestatus]);
...

{
  !buttonset && (
    ...
    <h1 className="mb-8 text-start lg:text-4xl md:text-4xl text-xl font-bold leading-none tracking-normal text-gray-100 md:text-3xl md:tracking-tight lg:flex md:flex">
                    {votestatus === 'accepted'? (
                      <div className={`text-white lg:ml-20 md:ml-20 ml-10 mt-10`}>All Accepted Reports</div>
                    ): votestatus === 'rejected' ? (
                      <div className={`text-white lg:ml-20 md:ml-20 ml-10 mt-10`}>All Rejected Reports</div>
                    ): (
                      <div className={`text-white lg:ml-20 md:ml-20 ml-10 mt-10`}>All Undervoting Reports</div>
                    )}
                  ...
                  <div className="flex p-6 text-white ml-14">
                    ...
                    style={{
                      backgroundColor: votestatus === 'accepted' ? '#4B5995' : '#222944',
                    }}
                     onClick={()=>setvotestatus("accepted")}>Accepted</button>
                    <button className="p-4 px-10" 
                    style={{
                      backgroundColor: votestatus === 'running' ? '#4B5995' : '#222944',
                    }}
                     onClick={()=>setvotestatus("running")}>Undervoting</button>
                    <button className="p-4 px-10" 
                    style={{
                      backgroundColor: votestatus === 'rejected' ? '#4B5995' : '#222944',
                    }}
                     onClick={()=>setvotestatus("rejected")}>Rejected</button>
                  </div>
...
Submit Your Findings Today!</h2>
            ...
            <>
                <AllReportsContainer metaDataArray={projectsData} MyReviews={false}/>
            </>
          )}
