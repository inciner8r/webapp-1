    ...
    <div className="flex-none">
      <ul className="menu menu-horizontal px-1">
        <li tabIndex={0}>
          ...
          <ul className="-p-10">
            <li><Link to="/my-reviews" className='bg-black z-10 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-200 to-green-400'>My Reviews</Link></li>
            <li><Link to="/all-reviews" className='bg-black z-10 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-200 to-green-400'>All Reviews</Link></li>
