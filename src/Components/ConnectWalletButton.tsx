    ...
    if (!walletData || !jwtToken) {
        return (
            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                <button onClick={connectWallet} className='inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-black bg-green-300 rounded-2xl sm:w-auto sm:mb-0 hover:bg-green-200 focus:ring focus:ring-green-300 focus:ring-opacity-80'>Connect Wallet</button>
            </div>
        )
    }
