    ...
    <div className="mt-10 pt-3 sm:pt-3 lg:pt-3 bg-black">
      <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="flex flex-col items-center border-t pt-6">
          ...
          <a href="https://discordapp.com/invite/5uaFhNpRF6" target="_blank" rel="noreferrer" className="text-green-200 transition duration-100 hover:text-green-400 active:text-green-600">
