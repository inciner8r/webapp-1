...
import upfill from '../assets/upfill.png';
import downfill from '../assets/downfill.png';
import quesfill from '../assets/Questionfill.png';
      ...
      >
            <div>
              ...
              <div style={background} className="p-4 rounded-xl">
                  ...
                  <div className="flex text-gray-300 pt-20 gap-10">
                    <div className="w-3/5 flex justify-between">
                      <div className="flex">
                        <div>Upvote {metaData.upvotes}</div>
                        {
                        metaData.userVote === "upvote" ? (
                        <img src={upfill} className="w-6 h-6"/>
                        ):(
                      ...
                      <div className="flex">
                        ...
                        {
                        metaData.userVote === "downvote" ? (
                        <img src={downfill} className="w-6 h-6"/>
                        ):(
                    ...
                    <div className="flex gap-1">
                      ...
                      {
                        metaData.userVote === "notsure" ? (
                        <img src={quesfill} className="w-6 h-6"/>
                        ):(
                    ...
                    <div className="w-2/5 text-right text-red-500 text-sm">
